...
public class TaskExecutor
{
	...
	public TaskExecutor(String executorName, int poolSize,
			int warningQueueSize, int criticalQueueSize, int threadPriority,
			QueueStateCallback queueStateCallback)
	{
		...
		this.threadPool = new ThreadPoolExecutor(
				...
				HackathonThreadFactory.getThreadFactory(executorName, threadPriority));
